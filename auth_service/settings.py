...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-z5p-8dy=y+x*gf)x!^7zaj9cd_*v_z!cg4m(6r1jj@kt)9%duv')
...
if not DEBUG:
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='naebak_auth'),
...
# JWT Configuration
JWT_SECRET_KEY = config('JWT_SECRET_KEY', default='naebak-jwt-secret-key-2024-very-secure')
