...
class User(AbstractUser):
    ...
    national_id = models.CharField(
        max_length=14, unique=True, blank=True, null=True, verbose_name="الرقم القومي"
    )
    governorate = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="المحافظة"
    )
    city = models.CharField(
        max_length=50, blank=True, null=True, verbose_name="المدينة"
    )
    ...
    google_id = models.CharField(
        max_length=255, blank=True, null=True, unique=True, verbose_name="معرف Google"
    )
    google_email = models.EmailField(
        blank=True, null=True, verbose_name="بريد Google الإلكتروني"
    )
